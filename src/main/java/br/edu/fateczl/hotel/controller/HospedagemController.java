...
public class HospedagemController {
    ...
    @PostMapping("/criar")
    public String criarHospedagem(@ModelAttribute HospedagemDTO hospedagem, Model model) {
    ...
    public String atualizarHospedagem(@ModelAttribute HospedagemDTO hospedagem, Model model) {
